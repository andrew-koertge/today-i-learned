...
function NewFactForm({setFacts, setShowForm}) {
  ...
  <input type="text" placeholder="Trustworthy source..." disabled={isUploading} 
...
function Fact({fact, setFacts}) {
 ...
 <div className="vote-buttons">
   <button onClick={()=>handleVote("votesInteresting")} disabled={isUpdating}>👍 <b>{fact.votesInteresting}</b></button>
   <button onClick={()=>handleVote("votesMindblowing")}>🤯 <b>{fact.votesMindblowing}</b></button>
   <button onClick={()=>handleVote("votesFalse")}>⛔ <b>{fact.votesFalse}</b></button>
 </div>
</li>
}
